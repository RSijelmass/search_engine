...
#initialise crawler with seeds
crawler = Crawler.new(['http://codecademy.com','http://bbc.co.uk', 'https://en.wikipedia.org/wiki/Web_crawler', 'http://www.makersacademy.com'])
crawler.fetch_data
...
ranker_list = indexer.page_hashes.inject([]) do |list, page_hash|
...
sorted_list = ranker_list.sort_by do |ranker|
  -ranker.word_score
end
